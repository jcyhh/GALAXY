<template>
    ...
    <div class="top">
        ...
        <div class="flex ac mt50">
            <div class="mr64">
                <div class="size24 opc6">收益USDT</div>
                <div class="size28 mt12">100</div>
            </div>
            <div>
                <div class="size24 opc6">PE总资产</div>
                <div class="size28 mt12">100</div>
            </div>
        </div>
    </div>
