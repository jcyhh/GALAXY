 ...
 * @returns {Number} a * b
 */
export function computedMul(a:number, b:number) :number {
    var c = 0,
        d = Number(a).toString(),
        e = Number(b).toString();
    try {
 ...
 */
export function computedDiv(a:number, b:number) :number {
    var c, d, e = 0,
        f = 0;
    try {
 ...
 * @returns {Number} a + b
 */
export function computedAdd(a:number, b:number) :number {
    var c, d, e;
    try {
 ...
 * @returns {Number} a - b
 */
export function computedSub(a:number, b:number) :number {
    var c, d, e;
    try {
        c = Number(a).toString().split(".")[1].length
    } catch (f) {
